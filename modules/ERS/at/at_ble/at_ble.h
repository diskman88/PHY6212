...
#define AT_ERR_BT_KV_SAVE_PARAM            (-12)
#define AT_ERR_AT_SERVICE_NOT_INITIALIZED  (-13)
#define AT_ERR_CMD_NOT_SUPPORTED           (-14)
#define AT_ERR_BT_TX_LEN                   (-15)
#define AT_ERR_BT_TX_FAILED                (-16)
#define AT_ERR_BT_FIND_NO_DEV              (-17)
#define AT_ERR_BT_GET_CONN_INFO_FAILD      (-18)
