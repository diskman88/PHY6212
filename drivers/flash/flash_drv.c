...
static dev_t *yoc_eflash_init(driver_t *drv,void *config, int id)
{
...
static int yoc_eflash_lpm(dev_t *dev, int state)
{

    return 0;
}

static int yoc_eflash_open(dev_t *dev)
{
...
static int yoc_eflash_close(dev_t *dev)
{
    flash_dev_t *flash = (flash_dev_t*)dev;
...
static int yoc_eflash_read(dev_t *dev, uint32_t addroff, void *buff, int32_t bytesize)
{
    flash_dev_t *flash = (flash_dev_t*)dev;
    int ret;
...
static int yoc_eflash_program(dev_t *dev, uint32_t dstaddr, const void *srcbuf, int32_t bytesize)
{
    flash_dev_t *flash = (flash_dev_t*)dev;
...
static int yoc_eflash_erase(dev_t *dev, int32_t addroff, int32_t blkcnt)
{
    flash_dev_t *flash = (flash_dev_t*)dev;
    int ret;
    int i;
...
static int yoc_eflash_get_info(dev_t *dev, flash_dev_info_t *info)
{
    flash_dev_t *flash = (flash_dev_t*)dev;
