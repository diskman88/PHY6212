...
static  gatt_attr_t test_attrs[] = {
    ...
    [TEST_IDX_CHAR3_CCC] = GATT_CHAR_CCC_DEFINE(bas_ccc_cfg),
...
static BT_STACK_NOINIT(transport_task_stack, 2048);
...
static gatt_attr_t test3_attrs0[] = {
    ...
    [TEST3_IDX_TX_CCC] = GATT_CHAR_CCC_DEFINE(test3_ccc_cfg),
};
...
static void transport_task(void *arg)
{
    ...
    while (1) {
        ...
        if (test3_svc.op == 1) {
            ...
            float speed = ((test3_svc.data_len * 1000) >> 10) / (trans_end_time - trans_start_time);
