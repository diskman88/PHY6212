...
void adv_timer_callback(void *arg1, void *arg2)
{
...
int app_main(int argc, char *argv[])
{
    ...
    start_adv();
    aos_timer_t adv_timer;
    aos_timer_new_ext(&adv_timer, adv_timer_callback, NULL, 10000, 0, 1);

    while (1) {
        uint32_t actl_flags;
        extern void board_led_set(uint8_t led, bool new_state);
        board_led_set(0, 0);
