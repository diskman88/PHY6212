...
static int32_t test_user_defined_fun(timer_handle_t timer_handle)
{
    ...
    ret = csi_timer_set_timeout(timer_handle, 3000000);
...
static int32_t test_timer(uint8_t timer_num)
{
    ...
    printf("timer free_running test successfully\n");
    ...
    printf("time out 3s successfully\n");//max (double)((double)(0xFFFFFF)/(4000000.0))
