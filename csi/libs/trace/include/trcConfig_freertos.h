 ...
 *
 * Using too small values will cause trace_error to be called, which stores an 
 ...
 * See trace_user_event() and trace_printf() in trcUser.h
 * 
 * Default value is 1.
 *
 ...
 * require that you insert calls to trace_store_isr_begin and trace_store_isr_end 
 ...
 * Floating point values are only used in trace_printf and its subroutines, to 
 * store float (%f) or double (%lf) arguments. 
 *
 * trace_printf can be used with integer and string arguments in either case.
 *
 * Default value is 1.
 *****************************************************************************/
 ...
 * to specify this individually for each task (see trace_task_instance_finish).
 *
 ...
 * with calls to trace_task_instance_finish for specific tasks.
 *
 ...
 * trace_task_instance_finish() at suitable locations to mark the IFEs.
 *****************************************************************************/
 ...
 * true. If the condition is false, trace_error() will be called.
...
/*******************************************************************************
 * CONFIG_OS_TRACE_TRIGGER
 *
 * Macro which should be defined as 0/1.
 *
 * This defines trace trigger enable(1)/disable(0).
 ******************************************************************************/
